                    ...
                    return (
                        ...
                        >
                            <span
                                className={
                                    active
                                        ? "grid size-[42px] place-items-center rounded-full bg-gradient-to-t from-[#6E56F5]/80 via-[#6E56F5]/25 to-transparent text-white"
                                        : circled
                            ...
                            <span
                                className={`text-[10px] font-semibold tracking-tight ${active ? "text-white" : "text-[#7A738F]"
                                    }`}
                            >
                                {item.label}
                            </span>
